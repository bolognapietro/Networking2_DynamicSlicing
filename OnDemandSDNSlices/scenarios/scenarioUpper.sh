...
printf "[INFO] Loading Scenario UpperSlice \n"
...
queues:12=@1q queues:56=@2q queues:34=@3q -- \
--id=@1q create queue other-config:min-rate=1000000 other-config:max-rate=20000000 -- \
--id=@2q create queue other-config:min-rate=1000000 other-config:max-rate=80000000 -- \
--id=@3q create queue other-config:min-rate=1000000 other-config:max-rate=100000000
